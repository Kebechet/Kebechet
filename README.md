...
![Blazor](https://img.shields.io/badge/Blazor-5C2D91?logo=blazor&logoColor=fff)
![MAUI](https://img.shields.io/badge/.NET%20MAUI-512BD4?logo=dotnet&logoColor=fff)
...
* 🧊 **[Blazor.ThreeJS](https://github.com/Kebechet/Blazor.ThreeJS)** - Typed three.js scene graph for Blazor with batched interop, ships the three.js bundle [![Downloads](https://img.shields.io/nuget/dt/Kebechet.Blazor.ThreeJS?logo=nuget&label=&color=004880)](https://www.nuget.org/packages/Kebechet.Blazor.ThreeJS)
